return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    --     fn = function(prompt)
    --       -- called with the current prompt text, returns a list of results
    --       return fff.file_search(prompt).items -- e.g. { "a.lua", "b.lua" }
    --     end,
    ...
    --         display = entry,
    --         ordinal = entry,
    --         path = entry, -- makes file previewers + <CR> jump work
    --       }
    --     end,
    --   }),
